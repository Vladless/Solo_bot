...
def build_management_kb() -> InlineKeyboardMarkup:
    ...
    builder.button(text="📛 Управление банами", callback_data=AdminPanelCallback(action="bans").pack())
    ...
    builder.button(text=maintenance_text, callback_data=AdminPanelCallback(action="toggle_maintenance").pack())
