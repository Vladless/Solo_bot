...
KEY_EXPIRY_10H = "🔔 Уведомление: Ваш ключ для сервера {server_id} истекает через 10 часов.\n" \
                 "Email: {email}\n" \
                 "Дата истечения: {expiry_date}"

KEY_EXPIRY_24H = "⏳ Уведомление: Ваш ключ для сервера {server_id} истекает через 24 часа.\n" \
                  "Email: {email}\n" \
