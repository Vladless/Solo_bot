...
| ✅ **Для личного использования** | Код можно использовать и модифицировать посде согласия автора, в том числе после покупки. |

> 🔴 **Нарушение приведёт к блокировке доступа и ответственности в РФ.**
