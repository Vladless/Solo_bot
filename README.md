...
| **Безопасность и стабильность** | • Периодические бэкапы <br> • Смена домена в случае переезда <br> • Проверка доступности серверов <br> • Уведомление о недоступности сервера и его аптайм <br> • Поддержка различных клиентов (Happ, Hiddify, v2raytun) <br> • Кастомизируемые заголовки профилей |
...
|----|---------------------------------------------------------------------|
| ⛔ **Монетизация кода запрещена** | Нельзя продавать, перепродавать или использовать код в коммерческих целях без разрешения автора. |
| ✅ **Для личного использования** | Код можно использовать и модифицировать только с согласия автора, даже после покупки. |
