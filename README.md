...
|----|---------------------------------------------------------------------|
| ⛔ **Монетизация кода запрещена** | Нельзя продавать, перепродавать или использовать код в коммерческих целях. |
| ✅ **Для личного использования** | Код можно использовать и модифицировать только в некоммерческих целях. |
