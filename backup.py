...
async def backup_database() -> Optional[Exception]:
    """
...
def _create_database_backup() -> Tuple[Optional[str], Optional[Exception]]:
    """
...
def _cleanup_old_backups() -> Optional[Exception]:
    """
