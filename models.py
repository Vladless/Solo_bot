from sqlalchemy import Column, BigInteger, Float, Text, Boolean, ForeignKey
...
class Connection(Base):
    ...
    referrals_received = relationship('Referral', foreign_keys='Referral.referred_tg_id', back_populates='referred')
    referrals_sent = relationship('Referral', foreign_keys='Referral.referrer_tg_id', back_populates='referrer')
...
class Key(Base):
    ...
    tg_id = Column(BigInteger, ForeignKey('connections.tg_id'), primary_key=True, nullable=False)
...
class Referral(Base):
    ...
    referred_tg_id = Column(BigInteger, ForeignKey('connections.tg_id'), primary_key=True, nullable=False)
    ...
    referred = relationship('Connection', foreign_keys=[referred_tg_id], back_populates='referrals_received')
    referrer = relationship('Connection', foreign_keys=[referrer_tg_id], back_populates='referrals_sent') 